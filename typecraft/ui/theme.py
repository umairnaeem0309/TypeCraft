...
COLOR_ACCENT = (33, 150, 243)                # Leaderboard / export actions
COLOR_SECONDARY = (0, 137, 123)              # Import / sync action
COLOR_SECONDARY_DARK = (88, 86, 160)        # Teacher security action
COLOR_ADMIN = (121, 85, 72)                  # Teacher Dashboard panel accent
